...
abstract class VKDoc_Api_Full {
	 ...
	 * @return VKDoc_ReturnValue_isAppUser
	 */
	public function isAppUser($uid = null){
		$params = array();
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_isAppUser($this->Call('isAppUser',$params));
	 ...
	 * @return VKDoc_ReturnValue_users_get
	 */
	public function users_get($uids, $namecase = null, $fields = null){
		...
		return new VKDoc_ReturnValue_users_get($this->Call('users.get',$params));
	 ...
	 * @return VKDoc_ReturnValue_users_search
	 */
	public function users_search($q, $offset = null, $fields = null, $count = null){
		...
		return new VKDoc_ReturnValue_users_search($this->Call('users.search',$params));

	}
	/**
	 * возвращает баланс текущего пользователя в данном приложении.
	 * @return VKDoc_ReturnValue_getUserBalance
	 */
	public function getUserBalance(){
		$params = array();
		return new VKDoc_ReturnValue_getUserBalance($this->Call('getUserBalance',$params));

	}
	/**
	 * возвращает настройки приложения текущего пользователя.
	 * @param $uid mixed ID пользователя. По умолчанию ID текущего пользователя.
	 * @return VKDoc_ReturnValue_getUserSettings
	 */
	public function getUserSettings($uid = null){
		$params = array();
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_getUserSettings($this->Call('getUserSettings',$params));
	 ...
	 * @return VKDoc_ReturnValue_likes_getList
	 */
	public function likes_getList($type, $offset = null, $count = null, $friendsonly = null, $pageurl = null, $ownerid = null, $itemid = null, $filter = null){
		...
		return new VKDoc_ReturnValue_likes_getList($this->Call('likes.getList',$params));
	 ...
	 * @return VKDoc_ReturnValue_friends_get
	 */
	public function friends_get($lid = null, $order = null, $offset = null, $count = null, $fields = null, $namecase = null, $uid = null){
		...
		if($namecase !== null){ $params['namecase'] = $namecase;}
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_friends_get($this->Call('friends.get',$params));

	}
	/**
	 * возвращает список id друзей пользователя, которые установили данное приложение.
	 * @return VKDoc_ReturnValue_friends_getAppUsers
	 */
	public function friends_getAppUsers(){
		$params = array();
		return new VKDoc_ReturnValue_friends_getAppUsers($this->Call('friends.getAppUsers',$params));
	 ...
	 * @return VKDoc_ReturnValue_friends_getOnline
	 */
	public function friends_getOnline($uid = null){
		$params = array();
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_friends_getOnline($this->Call('friends.getOnline',$params));
	 ...
	 * @return VKDoc_ReturnValue_friends_getMutual
	 */
	public function friends_getMutual($targetuid, $sourceuid = null){
		...
		return new VKDoc_ReturnValue_friends_getMutual($this->Call('friends.getMutual',$params));
	 ...
	 * @return VKDoc_ReturnValue_friends_areFriends
	 */
	public function friends_areFriends($uids){
		$params = array();
		$params['uids'] = $uids;
		return new VKDoc_ReturnValue_friends_areFriends($this->Call('friends.areFriends',$params));
	 ...
	 * @return VKDoc_ReturnValue_groups_get
	 */
	public function groups_get($fields = null, $filter = null, $extended = null, $uid = null){
		...
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_groups_get($this->Call('groups.get',$params));
	 ...
	 * @param $fields mixed Список полей из информации о группах, которые необходимо получить. См. [[Параметр fields для групп]]
	 * @return VKDoc_ReturnValue_groups_getById
	 */
	public function groups_getById($gidsgid, $fields = null){
		$params = array();
		$params['gidsgid'] = $gidsgid;
		if($fields !== null){ $params['fields'] = $fields;}
		return new VKDoc_ReturnValue_groups_getById($this->Call('groups.getById',$params));
	 ...
	 * @param $uid mixed ID пользователя. По умолчанию ID текущего пользователя.
	 * @return VKDoc_ReturnValue_groups_isMember
	 */
	public function groups_isMember($gid, $extended = null, $uid = null){
		...
		if($extended !== null){ $params['extended'] = $extended;}
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_groups_isMember($this->Call('groups.isMember',$params));
	 ...
	 * @return VKDoc_ReturnValue_groups_getMembers
	 */
	public function groups_getMembers($gid, $sort = null, $count = null, $offset = null){
		...
		if($count !== null){ $params['count'] = $count;}
		if($offset !== null){ $params['offset'] = $offset;}
		return new VKDoc_ReturnValue_groups_getMembers($this->Call('groups.getMembers',$params));
	 ...
	 * @return VKDoc_ReturnValue_groups_search
	 */
	public function groups_search($count = null, $offset = null, $q = null){
		...
		return new VKDoc_ReturnValue_groups_search($this->Call('groups.search',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_getAlbums
	 */
	public function photos_getAlbums($needcovers = null, $aids = null, $gid = null, $uid = null){
		...
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_photos_getAlbums($this->Call('photos.getAlbums',$params));
	 ...
	 * @param $gid mixed ID группы, которой принадлежат альбомы.
	 * @param $uid mixed ID пользователя, которому принадлежат альбомы. По умолчанию – ID текущего пользователя.
	 * @return VKDoc_ReturnValue_photos_getAlbumsCount
	 */
	public function photos_getAlbumsCount($gid = null, $uid = null){
		$params = array();
		if($gid !== null){ $params['gid'] = $gid;}
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_photos_getAlbumsCount($this->Call('photos.getAlbumsCount',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_get
	 */
	public function photos_get($uid, $aid, $gid, $feed = null, $feedtype = null, $offset = null, $extended = null, $pids = null, $limit = null){
		...
		return new VKDoc_ReturnValue_photos_get($this->Call('photos.get',$params));
	 ...
	 * @param $extended mixed '1' - будет возвращено дополнительное поле 'likes'. По умолчанию поле 'likes' не возвращается.
	 * @param $limit mixed количество фотографий, которое нужно вернуть. (по умолчанию – 'все фотографии')
	 * @return VKDoc_ReturnValue_photos_getProfile
	 */
	public function photos_getProfile($uid, $offset = null, $extended = null, $limit = null){
		...
		if($extended !== null){ $params['extended'] = $extended;}
		if($limit !== null){ $params['limit'] = $limit;}
		return new VKDoc_ReturnValue_photos_getProfile($this->Call('photos.getProfile',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_getAll
	 */
	public function photos_getAll($extended = null, $count = null, $offset = null, $ownerid = null){
		...
		if($offset !== null){ $params['offset'] = $offset;}
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_photos_getAll($this->Call('photos.getAll',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_getById
	 */
	public function photos_getById($extended = null, $photos = null){
		$params = array();
		if($extended !== null){ $params['extended'] = $extended;}
		if($photos !== null){ $params['photos'] = $photos;}
		return new VKDoc_ReturnValue_photos_getById($this->Call('photos.getById',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_createAlbum
	 */
	public function photos_createAlbum($title, $gid = null, $description = null, $commentprivacy = null, $privacy = null){
		...
		return new VKDoc_ReturnValue_photos_createAlbum($this->Call('photos.createAlbum',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_editAlbum
	 */
	public function photos_editAlbum($aid, $title, $description = null, $privacy = null, $commentprivacy = null){
		...
		if($privacy !== null){ $params['privacy'] = $privacy;}
		if($commentprivacy !== null){ $params['commentprivacy'] = $commentprivacy;}
		return new VKDoc_ReturnValue_photos_editAlbum($this->Call('photos.editAlbum',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_edit
	 */
	public function photos_edit($pid, $caption = null, $ownerid = null){
		...
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_photos_edit($this->Call('photos.edit',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_move
	 */
	public function photos_move($pid, $targetaid, $oid = null){
		...
		return new VKDoc_ReturnValue_photos_move($this->Call('photos.move',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_makeCover
	 */
	public function photos_makeCover($pid, $aid, $oid = null){
		...
		$params['aid'] = $aid;
		if($oid !== null){ $params['oid'] = $oid;}
		return new VKDoc_ReturnValue_photos_makeCover($this->Call('photos.makeCover',$params));
	 ...
	 * @param $oid mixed id владельца альбома, по умолчанию id текущего пользователя.
	 * @return VKDoc_ReturnValue_photos_reorderAlbums
	 */
	public function photos_reorderAlbums($after, $before, $aid, $oid = null){
		...
		$params['aid'] = $aid;
		if($oid !== null){ $params['oid'] = $oid;}
		return new VKDoc_ReturnValue_photos_reorderAlbums($this->Call('photos.reorderAlbums',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_reorderPhotos
	 */
	public function photos_reorderPhotos($after, $before, $pid, $oid = null){
		...
		$params['pid'] = $pid;
		if($oid !== null){ $params['oid'] = $oid;}
		return new VKDoc_ReturnValue_photos_reorderPhotos($this->Call('photos.reorderPhotos',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_getUploadServer
	 */
	public function photos_getUploadServer($aid, $gid = null){
		$params = array();
		$params['aid'] = $aid;
		if($gid !== null){ $params['gid'] = $gid;}
		return new VKDoc_ReturnValue_photos_getUploadServer($this->Call('photos.getUploadServer',$params));
	 ...
	 * @param $gid mixed ID группы, при загрузке фотографии в группу.
	 * @return VKDoc_ReturnValue_photos_save
	 */
	public function photos_save($hash, $aid, $photoslist, $server, $caption = null, $gid = null){
		...
		if($caption !== null){ $params['caption'] = $caption;}
		if($gid !== null){ $params['gid'] = $gid;}
		return new VKDoc_ReturnValue_photos_save($this->Call('photos.save',$params));

	}
	/**
	 * возвращает адрес сервера для загрузки фотографии на страницу пользователя.
	 * @return VKDoc_ReturnValue_photos_getProfileUploadServer
	 */
	public function photos_getProfileUploadServer(){
		$params = array();
		return new VKDoc_ReturnValue_photos_getProfileUploadServer($this->Call('photos.getProfileUploadServer',$params));
	 ...
	 * @param $server mixed параметр, возвращаемый в результате загрузки фотографий на сервер.
	 * @return VKDoc_ReturnValue_photos_saveProfilePhoto
	 */
	public function photos_saveProfilePhoto($hash, $photo, $server){
		...
		$params['photo'] = $photo;
		$params['server'] = $server;
		return new VKDoc_ReturnValue_photos_saveProfilePhoto($this->Call('photos.saveProfilePhoto',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_getWallUploadServer
	 */
	public function photos_getWallUploadServer($gid = null, $uid = null){
		$params = array();
		if($gid !== null){ $params['gid'] = $gid;}
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_photos_getWallUploadServer($this->Call('photos.getWallUploadServer',$params));
	 ...
	 * @param $gid mixed ID группы, при загрузке фотографии на стену группы.
	 * @param $uid mixed ID пользователя, при загрузке фотографии на стену другому пользователю.
	 * @return VKDoc_ReturnValue_photos_saveWallPhoto
	 */
	public function photos_saveWallPhoto($server, $hash, $photo, $gid = null, $uid = null){
		...
		if($gid !== null){ $params['gid'] = $gid;}
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_photos_saveWallPhoto($this->Call('photos.saveWallPhoto',$params));
	 ...
	 * @return VKDoc_ReturnValue_wall_get
	 */
	public function wall_get($extended = null, $filter = null, $count = null, $offset = null, $ownerid = null){
		...
		if($offset !== null){ $params['offset'] = $offset;}
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_wall_get($this->Call('wall.get',$params));
	 ...
	 * @return VKDoc_ReturnValue_wall_getComments
	 */
	public function wall_getComments($postid, $count = null, $previewlength = null, $offset = null, $needlikes = null, $sort = null, $ownerid = null){
		...
		if($sort !== null){ $params['sort'] = $sort;}
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_wall_getComments($this->Call('wall.getComments',$params));
	 ...
	 * @return VKDoc_ReturnValue_wall_getById
	 */
	public function wall_getById($posts){
		$params = array();
		$params['posts'] = $posts;
		return new VKDoc_ReturnValue_wall_getById($this->Call('wall.getById',$params));
	 ...
	 * @return VKDoc_ReturnValue_wall_post
	 */
	public function wall_post($services = null, $fromgroup = null, $signed = null, $friendsonly = null, $placeid = null, $long = null, $message = null, $attachments = null, $lat = null, $ownerid = null){
		...
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_wall_post($this->Call('wall.post',$params));
	 ...
	 * @return VKDoc_ReturnValue_newsfeed_get
	 */
	public function newsfeed_get($from = null, $count = null, $maxphotos = null, $offset = null, $endtime = null, $filters = null, $starttime = null, $sourceids = null){
		...
		return new VKDoc_ReturnValue_newsfeed_get($this->Call('newsfeed.get',$params));
	 ...
	 * @return VKDoc_ReturnValue_newsfeed_search
	 */
	public function newsfeed_search($startid = null, $extended = null, $endtime = null, $starttime = null, $count = null, $offset = null, $q = null){
		...
		if($offset !== null){ $params['offset'] = $offset;}
		if($q !== null){ $params['q'] = $q;}
		return new VKDoc_ReturnValue_newsfeed_search($this->Call('newsfeed.search',$params));
	 ...
	 * @return VKDoc_ReturnValue_notifications_get
	 */
	public function notifications_get($count = null, $offset = null, $endtime = null, $starttime = null, $filters = null){
		...
		if($starttime !== null){ $params['starttime'] = $starttime;}
		if($filters !== null){ $params['filters'] = $filters;}
		return new VKDoc_ReturnValue_notifications_get($this->Call('notifications.get',$params));

	}
	/**
	 * сбрасывает счетчик новых оповещений.
	 * @return VKDoc_ReturnValue_notifications_markAsViewed
	 */
	public function notifications_markAsViewed(){
		$params = array();
		return new VKDoc_ReturnValue_notifications_markAsViewed($this->Call('notifications.markAsViewed',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_get
	 */
	public function audio_get($count = null, $offset = null, $needuser = null, $aids = null, $gid = null, $albumid = null, $uid = null){
		...
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_audio_get($this->Call('audio.get',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_getById
	 */
	public function audio_getById($audios = null){
		$params = array();
		if($audios !== null){ $params['audios'] = $audios;}
		return new VKDoc_ReturnValue_audio_getById($this->Call('audio.getById',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_getCount
	 */
	public function audio_getCount($oid){
		$params = array();
		$params['oid'] = $oid;
		return new VKDoc_ReturnValue_audio_getCount($this->Call('audio.getCount',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_getLyrics
	 */
	public function audio_getLyrics($lyricsid = null){
		$params = array();
		if($lyricsid !== null){ $params['lyricsid'] = $lyricsid;}
		return new VKDoc_ReturnValue_audio_getLyrics($this->Call('audio.getLyrics',$params));

	}
	/**
	 * возвращает адрес сервера для [[Процесс загрузки файлов на сервер ВКонтакте|загрузки аудиозаписей]].
	 * @return VKDoc_ReturnValue_audio_getUploadServer
	 */
	public function audio_getUploadServer(){
		$params = array();
		return new VKDoc_ReturnValue_audio_getUploadServer($this->Call('audio.getUploadServer',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_save
	 */
	public function audio_save($server, $hash, $audio, $title = null, $artist = null){
		...
		return new VKDoc_ReturnValue_audio_save($this->Call('audio.save',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_search
	 */
	public function audio_search($q, $offset = null, $count = null, $sort = null, $autocomplete = null, $lyrics = null){
		...
		return new VKDoc_ReturnValue_audio_search($this->Call('audio.search',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_add
	 */
	public function audio_add($aid, $oid, $gid = null){
		...
		$params['oid'] = $oid;
		if($gid !== null){ $params['gid'] = $gid;}
		return new VKDoc_ReturnValue_audio_add($this->Call('audio.add',$params));
	 ...
	 * @param $aid mixed id аудиозаписи.
	 * @return VKDoc_ReturnValue_audio_delete
	 */
	public function audio_delete($oid, $aid){
		$params = array();
		$params['oid'] = $oid;
		$params['aid'] = $aid;
		return new VKDoc_ReturnValue_audio_delete($this->Call('audio.delete',$params));
	 ...
	 * @param $aid mixed id аудиозаписи.
	 * @return VKDoc_ReturnValue_audio_edit
	 */
	public function audio_edit($text, $nosearch, $title, $artist, $oid, $aid){
		...
		$params['oid'] = $oid;
		$params['aid'] = $aid;
		return new VKDoc_ReturnValue_audio_edit($this->Call('audio.edit',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_restore
	 */
	public function audio_restore($aid, $oid = null){
		$params = array();
		$params['aid'] = $aid;
		if($oid !== null){ $params['oid'] = $oid;}
		return new VKDoc_ReturnValue_audio_restore($this->Call('audio.restore',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_reorder
	 */
	public function audio_reorder($after, $aid, $before, $oid = null){
		...
		$params['before'] = $before;
		if($oid !== null){ $params['oid'] = $oid;}
		return new VKDoc_ReturnValue_audio_reorder($this->Call('audio.reorder',$params));
	 ...
	 * @param $gid mixed id группы, которой принадлежат аудиозаписи. Если указан параметр gid, uid игнорируется.
	 * @param $uid mixed id пользователя, которому принадлежат аудиозаписи (по умолчанию — текущий пользователь)
	 * @return VKDoc_ReturnValue_audio_getAlbums
	 */
	public function audio_getAlbums($offset = null, $count = null, $gid = null, $uid = null){
		...
		if($gid !== null){ $params['gid'] = $gid;}
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_audio_getAlbums($this->Call('audio.getAlbums',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_addAlbum
	 */
	public function audio_addAlbum($title, $gid = null){
		$params = array();
		$params['title'] = $title;
		if($gid !== null){ $params['gid'] = $gid;}
		return new VKDoc_ReturnValue_audio_addAlbum($this->Call('audio.addAlbum',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_editAlbum
	 */
	public function audio_editAlbum($title, $albumid, $gid = null){
		...
		if($gid !== null){ $params['gid'] = $gid;}
		return new VKDoc_ReturnValue_audio_editAlbum($this->Call('audio.editAlbum',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_deleteAlbum
	 */
	public function audio_deleteAlbum($albumid, $gid = null){
		$params = array();
		$params['albumid'] = $albumid;
		if($gid !== null){ $params['gid'] = $gid;}
		return new VKDoc_ReturnValue_audio_deleteAlbum($this->Call('audio.deleteAlbum',$params));
	 ...
	 * @return VKDoc_ReturnValue_audio_moveToAlbum
	 */
	public function audio_moveToAlbum($aids, $albumid, $gid = null){
		...
		$params['albumid'] = $albumid;
		if($gid !== null){ $params['gid'] = $gid;}
		return new VKDoc_ReturnValue_audio_moveToAlbum($this->Call('audio.moveToAlbum',$params));
	 ...
	 * @return VKDoc_ReturnValue_video_get
	 */
	 ...
	 * @return VKDoc_ReturnValue_video_search
	 */
	public function video_search($q, $offset = null, $count = null, $hd = null, $sort = null){
		...
		if($sort !== null){ $params['sort'] = $sort;}
		return new VKDoc_ReturnValue_video_search($this->Call('video.search',$params));
	 ...
	 * @return VKDoc_ReturnValue_video_getUserVideos
	 */
	 ...
	 * @param $ownerid mixed идентификатор пользователя (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_video_createComment
	 */
	public function video_createComment($vid, $message, $ownerid = null){
		...
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_video_createComment($this->Call('video.createComment',$params));
	 ...
	 * @param $ownerid mixed идентификатор пользователя (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_video_editComment
	 */
	public function video_editComment($message, $id, $ownerid = null){
		...
		$params['id'] = $id;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_video_editComment($this->Call('video.editComment',$params));
	 ...
	 * @param $ownerid mixed идентификатор пользователя (по-умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_video_deleteComment
	 */
	public function video_deleteComment($cid, $ownerid = null){
		$params = array();
		$params['cid'] = $cid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_video_deleteComment($this->Call('video.deleteComment',$params));
	 ...
	 * @param $vid mixed идентификатор видеозаписи.
	 * @param $ownerid mixed идентификатор пользователя (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_video_getTags
	 */
	public function video_getTags($vid, $ownerid = null){
		$params = array();
		$params['vid'] = $vid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_video_getTags($this->Call('video.getTags',$params));
	 ...
	 * @return VKDoc_ReturnValue_video_putTag
	 */
	public function video_putTag($uid, $vid, $ownerid = null){
		...
		$params['vid'] = $vid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_video_putTag($this->Call('video.putTag',$params));
	 ...
	 * @param $vid mixed идентификатор видеозаписи.
	 * @param $ownerid mixed идентификатор владельца видеозаписи (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_video_removeTag
	 */
	public function video_removeTag($tagid, $vid, $ownerid = null){
		...
		$params['vid'] = $vid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_video_removeTag($this->Call('video.removeTag',$params));

	}
	/**
	 * возвращает данные, необходимые для [[Процесс загрузки файлов на сервер ВКонтакте|загрузки видеозаписей]], а также данные видеозаписи.
	 ...
	 * @return VKDoc_ReturnValue_video_save
	 */
	public function video_save($privacycomment = null, $privacyview = null, $gid = null, $description = null, $name = null){
		...
		return new VKDoc_ReturnValue_video_save($this->Call('video.save',$params));
	 ...
	 * @return VKDoc_ReturnValue_video_getAlbums
	 */
	public function video_getAlbums($offset = null, $count = null, $gid = null, $uid = null){
		...
		if($gid !== null){ $params['gid'] = $gid;}
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_video_getAlbums($this->Call('video.getAlbums',$params));
	 ...
	 * @return VKDoc_ReturnValue_video_addAlbum
	 */
	public function video_addAlbum($title, $gid = null){
		$params = array();
		$params['title'] = $title;
		if($gid !== null){ $params['gid'] = $gid;}
		return new VKDoc_ReturnValue_video_addAlbum($this->Call('video.addAlbum',$params));
	 ...
	 * @return VKDoc_ReturnValue_video_editAlbum
	 */
	public function video_editAlbum($title, $albumid, $gid = null){
		...
		$params['albumid'] = $albumid;
		if($gid !== null){ $params['gid'] = $gid;}
		return new VKDoc_ReturnValue_video_editAlbum($this->Call('video.editAlbum',$params));
	 ...
	 * @return VKDoc_ReturnValue_video_deleteAlbum
	 */
	public function video_deleteAlbum($albumid, $gid = null){
		$params = array();
		$params['albumid'] = $albumid;
		if($gid !== null){ $params['gid'] = $gid;}
		return new VKDoc_ReturnValue_video_deleteAlbum($this->Call('video.deleteAlbum',$params));
	 ...
	 * @return VKDoc_ReturnValue_video_moveToAlbum
	 */
	public function video_moveToAlbum($vids, $albumid, $gid = null){
		...
		$params['albumid'] = $albumid;
		if($gid !== null){ $params['gid'] = $gid;}
		return new VKDoc_ReturnValue_video_moveToAlbum($this->Call('video.moveToAlbum',$params));
	 ...
	 * @return VKDoc_ReturnValue_docs_get
	 */
	public function docs_get($offset = null, $count = null, $oid = null){
		...
		if($count !== null){ $params['count'] = $count;}
		if($oid !== null){ $params['oid'] = $oid;}
		return new VKDoc_ReturnValue_docs_get($this->Call('docs.get',$params));
	 ...
	 * @return VKDoc_ReturnValue_docs_getById
	 */
	public function docs_getById($docs = null){
		$params = array();
		if($docs !== null){ $params['docs'] = $docs;}
		return new VKDoc_ReturnValue_docs_getById($this->Call('docs.getById',$params));

	}
	/**
	 * возвращает адрес сервера для [[Процесс загрузки файлов на сервер ВКонтакте|загрузки документов]].
	 * @return VKDoc_ReturnValue_docs_getUploadServer
	 */
	public function docs_getUploadServer(){
		$params = array();
		return new VKDoc_ReturnValue_docs_getUploadServer($this->Call('docs.getUploadServer',$params));
	 ...
	 * @return VKDoc_ReturnValue_docs_getWallUploadServer
	 */
	public function docs_getWallUploadServer(){
		$params = array();
		return new VKDoc_ReturnValue_docs_getWallUploadServer($this->Call('docs.getWallUploadServer',$params));
	 ...
	 * @return VKDoc_ReturnValue_docs_delete
	 */
	public function docs_delete($oid, $did){
		$params = array();
		$params['oid'] = $oid;
		$params['did'] = $did;
		return new VKDoc_ReturnValue_docs_delete($this->Call('docs.delete',$params));

	}
	/**
	 * Cохраняет загруженные документы.
	 * @param $file mixed Параметр, возвращаемый в результате загрузки файла на сервер.
	 * @return VKDoc_ReturnValue_docs_save
	 */
	public function docs_save($file){
		$params = array();
		$params['file'] = $file;
		return new VKDoc_ReturnValue_docs_save($this->Call('docs.save',$params));
	 ...
	 * @return VKDoc_ReturnValue_places_add
	 */
	public function places_add($title, $longitude, $type, $latitude, $address = null, $country = null, $city = null){
		...
		return new VKDoc_ReturnValue_places_add($this->Call('places.add',$params));
	 ...
	 * @return VKDoc_ReturnValue_places_getById
	 */
	public function places_getById($places = null){
		$params = array();
		if($places !== null){ $params['places'] = $places;}
		return new VKDoc_ReturnValue_places_getById($this->Call('places.getById',$params));
	 ...
	 * @return VKDoc_ReturnValue_places_search
	 */
	public function places_search($latitude, $longitude, $radius = null, $q = null){
		...
		if($q !== null){ $params['q'] = $q;}
		return new VKDoc_ReturnValue_places_search($this->Call('places.search',$params));
	 ...
	 * @return VKDoc_ReturnValue_places_checkin
	 */
	public function places_checkin($placeid, $friendsonly = null, $services = null, $latitude = null, $text = null, $longitude = null){
		...
		return new VKDoc_ReturnValue_places_checkin($this->Call('places.checkin',$params));
	 ...
	 * @return VKDoc_ReturnValue_places_getCheckins
	 */
	public function places_getCheckins($timestamp = null, $friendsonly = null, $needplaces = null, $count = null, $offset = null, $longitude = null, $place = null, $uid = null, $latitude = null){
		...
		if($uid !== null){ $params['uid'] = $uid;}
		if($latitude !== null){ $params['latitude'] = $latitude;}
		return new VKDoc_ReturnValue_places_getCheckins($this->Call('places.getCheckins',$params));

	}
	/**
	 * возвращает список типов мест.
	 * @return VKDoc_ReturnValue_places_getTypes
	 */
	public function places_getTypes(){
		$params = array();
		return new VKDoc_ReturnValue_places_getTypes($this->Call('places.getTypes',$params));
	 ...
	 * @return VKDoc_ReturnValue_places_getCountries
	 */
	public function places_getCountries($code = null, $needfull = null){
		$params = array();
		if($code !== null){ $params['code'] = $code;}
		if($needfull !== null){ $params['needfull'] = $needfull;}
		return new VKDoc_ReturnValue_places_getCountries($this->Call('places.getCountries',$params));
	 ...
	 * @return VKDoc_ReturnValue_places_getCities
	 */
	public function places_getCities($country, $q = null){
		$params = array();
		$params['country'] = $country;
		if($q !== null){ $params['q'] = $q;}
		return new VKDoc_ReturnValue_places_getCities($this->Call('places.getCities',$params));
	 ...
	 * @return VKDoc_ReturnValue_places_getRegions
	 */
	public function places_getRegions($country, $q = null){
		$params = array();
		$params['country'] = $country;
		if($q !== null){ $params['q'] = $q;}
		return new VKDoc_ReturnValue_places_getRegions($this->Call('places.getRegions',$params));

	}
	/**
	 * возвращает информацию о странах по их id.
	 * @param $cids mixed перечисленные через запятую ID стран.
	 * @return VKDoc_ReturnValue_places_getCountryById
	 */
	public function places_getCountryById($cids){
		$params = array();
		$params['cids'] = $cids;
		return new VKDoc_ReturnValue_places_getCountryById($this->Call('places.getCountryById',$params));

	}
	/**
	 * возвращает информацию о городах по их id.
	 * @param $cids mixed перечисленные через запятую ID городов.
	 * @return VKDoc_ReturnValue_places_getCityById
	 */
	public function places_getCityById($cids){
		$params = array();
		$params['cids'] = $cids;
		return new VKDoc_ReturnValue_places_getCityById($this->Call('places.getCityById',$params));

	}
	/**
	 * возвращает информацию об улицах по их id.
	 * @param $sids mixed перечисленные через запятую ID улиц.
	 * @return VKDoc_ReturnValue_places_getStreetById
	 */
	public function places_getStreetById($sids){
		$params = array();
		$params['sids'] = $sids;
		return new VKDoc_ReturnValue_places_getStreetById($this->Call('places.getStreetById',$params));
	 ...
	 * @return VKDoc_ReturnValue_secure_sendNotification
	 */
	public function secure_sendNotification($message, $uids, $random, $timestamp){
		...
		return new VKDoc_ReturnValue_secure_sendNotification($this->Call('secure.sendNotification',$params));
	 ...
	 * @param $random mixed любое случайное число для обеспечения уникальности запроса
	 * @param $timestamp mixed UNIX-time сервера.
	 * @return VKDoc_ReturnValue_secure_getAppBalance
	 */
	public function secure_getAppBalance($random, $timestamp){
		$params = array();
		$params['random'] = $random;
		$params['timestamp'] = $timestamp;
		return new VKDoc_ReturnValue_secure_getAppBalance($this->Call('secure.getAppBalance',$params));
	 ...
	 * @param $random mixed любое случайное число для обеспечения уникальности запроса
	 * @param $timestamp mixed UNIX-time сервера.
	 * @return VKDoc_ReturnValue_secure_getBalance
	 */
	public function secure_getBalance($uid, $random, $timestamp){
		...
		$params['random'] = $random;
		$params['timestamp'] = $timestamp;
		return new VKDoc_ReturnValue_secure_getBalance($this->Call('secure.getBalance',$params));
	 ...
	 * @return VKDoc_ReturnValue_secure_withdrawVotes
	 */
	public function secure_withdrawVotes($votes, $timestamp, $uid, $random, $testmode = null){
		...
		return new VKDoc_ReturnValue_secure_withdrawVotes($this->Call('secure.withdrawVotes',$params));
	 ...
	 * @return VKDoc_ReturnValue_secure_getTransactionsHistory
	 */
	public function secure_getTransactionsHistory($timestamp, $random, $dateto = null, $limit = null, $datefrom = null, $uidfrom = null, $type = null, $uidto = null){
		...
		return new VKDoc_ReturnValue_secure_getTransactionsHistory($this->Call('secure.getTransactionsHistory',$params));
	 ...
	 * @return VKDoc_ReturnValue_secure_addRating
	 */
	public function secure_addRating($rate, $timestamp, $uid, $random, $message = null){
		...
		$params['random'] = $random;
		if($message !== null){ $params['message'] = $message;}
		return new VKDoc_ReturnValue_secure_addRating($this->Call('secure.addRating',$params));
	 ...
	 * @param $random mixed любое случайное число для обеспечения уникальности запроса
	 * @param $timestamp mixed UNIX-time сервера.
	 * @return VKDoc_ReturnValue_secure_setCounter
	 */
	public function secure_setCounter($counter, $uid, $random, $timestamp){
		...
		$params['random'] = $random;
		$params['timestamp'] = $timestamp;
		return new VKDoc_ReturnValue_secure_setCounter($this->Call('secure.setCounter',$params));
	 ...
	 * @return VKDoc_ReturnValue_secure_setUserLevel
	 */
	public function secure_setUserLevel($uid, $level, $levels = null){
		...
		return new VKDoc_ReturnValue_secure_setUserLevel($this->Call('secure.setUserLevel',$params));
	 ...
	 * @return VKDoc_ReturnValue_secure_getUserLevel
	 */
	public function secure_getUserLevel($uids){
		$params = array();
		$params['uids'] = $uids;
		return new VKDoc_ReturnValue_secure_getUserLevel($this->Call('secure.getUserLevel',$params));
	 ...
	 * @param $datefrom mixed фильтр по дате начала. Задается в виде UNIX-time.
	 * @return VKDoc_ReturnValue_secure_getSMSHistory
	 */
	public function secure_getSMSHistory($timestamp, $random, $limit = null, $dateto = null, $uid = null, $datefrom = null){
		...
		if($uid !== null){ $params['uid'] = $uid;}
		if($datefrom !== null){ $params['datefrom'] = $datefrom;}
		return new VKDoc_ReturnValue_secure_getSMSHistory($this->Call('secure.getSMSHistory',$params));
	 ...
	 * @param $random mixed любое случайное число для обеспечения уникальности запроса
	 * @param $timestamp mixed UNIX-time сервера.
	 * @return VKDoc_ReturnValue_secure_sendSMSNotification
	 */
	public function secure_sendSMSNotification($message, $uid, $random, $timestamp){
		...
		$params['random'] = $random;
		$params['timestamp'] = $timestamp;
		return new VKDoc_ReturnValue_secure_sendSMSNotification($this->Call('secure.sendSMSNotification',$params));
	 ...
	 * @param $datefrom mixed фильтр по дате начала. Задается в виде UNIX-time.
	 * @return VKDoc_ReturnValue_secure_getSMS
	 */
	public function secure_getSMS($timestamp, $random, $dateto = null, $uid = null, $datefrom = null){
		...
		if($uid !== null){ $params['uid'] = $uid;}
		if($datefrom !== null){ $params['datefrom'] = $datefrom;}
		return new VKDoc_ReturnValue_secure_getSMS($this->Call('secure.getSMS',$params));

	}
	/**
	 * устанавливает префикс для приема SMS.
	 * @param $prefix mixed 3-16 символов латинского алфавита в формате UTF-8.
	 * @return VKDoc_ReturnValue_setSMSPrefix
	 */
	public function setSMSPrefix($prefix){
		$params = array();
		$params['prefix'] = $prefix;
		return new VKDoc_ReturnValue_setSMSPrefix($this->Call('setSMSPrefix',$params));

	}
	/**
	 * возвращает префикс для приема SMS.
	 * @return VKDoc_ReturnValue_getSMSPrefix
	 */
	public function getSMSPrefix(){
		$params = array();
		return new VKDoc_ReturnValue_getSMSPrefix($this->Call('getSMSPrefix',$params));
	 ...
	 * @return VKDoc_ReturnValue_storage_get
	 */
	public function storage_get($key, $uid = null, $keys = null, $global = null){
		...
		return new VKDoc_ReturnValue_storage_get($this->Call('storage.get',$params));
	 ...
	 * @return VKDoc_ReturnValue_storage_set
	 */
	public function storage_set($key, $uid = null, $value = null, $global = null){
		...
		if($global !== null){ $params['global'] = $global;}
		return new VKDoc_ReturnValue_storage_set($this->Call('storage.set',$params));
	 ...
	 * @return VKDoc_ReturnValue_execute
	 */
	public function execute($code){
		$params = array();
		$params['code'] = $code;
		return new VKDoc_ReturnValue_execute($this->Call('execute',$params));

	}
	/**
	 * возвращает текущее время.
	 * @return VKDoc_ReturnValue_getServerTime
	 */
	public function getServerTime(){
		$params = array();
		return new VKDoc_ReturnValue_getServerTime($this->Call('getServerTime',$params));
	 ...
	 * @return VKDoc_ReturnValue_setNameInMenu
	 */
	public function setNameInMenu($name){
		$params = array();
		$params['name'] = $name;
		return new VKDoc_ReturnValue_setNameInMenu($this->Call('setNameInMenu',$params));
	 ...
	 * @return VKDoc_ReturnValue_notes_get
	 */
	public function notes_get($offset = null, $count = null, $sort = null, $nids = null, $uid = null){
		...
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_notes_get($this->Call('notes.get',$params));
	 ...
	 * @return VKDoc_ReturnValue_notes_getById
	 */
	public function notes_getById($nid, $needwiki = null, $ownerid = null){
		...
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_notes_getById($this->Call('notes.getById',$params));
	 ...
	 * @param $offset mixed смещение, необходимое для выборки определенного подмножества заметок.
	 * @param $count mixed количество сообщений, которое необходимо получить (но не более 100). По умолчанию выставляется 20.
	 * @return VKDoc_ReturnValue_notes_getFriendsNotes
	 */
	public function notes_getFriendsNotes($offset = null, $count = null){
		$params = array();
		if($offset !== null){ $params['offset'] = $offset;}
		if($count !== null){ $params['count'] = $count;}
		return new VKDoc_ReturnValue_notes_getFriendsNotes($this->Call('notes.getFriendsNotes',$params));
	 ...
	 * @return VKDoc_ReturnValue_notes_add
	 */
	public function notes_add($title, $text, $commentprivacy = null, $privacy = null){
		...
		if($commentprivacy !== null){ $params['commentprivacy'] = $commentprivacy;}
		if($privacy !== null){ $params['privacy'] = $privacy;}
		return new VKDoc_ReturnValue_notes_add($this->Call('notes.add',$params));
	 ...
	 * @param $commentprivacy mixed уровень доступа к комментированию заметки. Значения: 0 – все пользователи, 1 – только друзья, 2 – друзья и друзья друзей, 3 - только пользователь.
	 * @param $privacy mixed уровень доступа к заметке. Значения: 0 – все пользователи, 1 – только друзья, 2 – друзья и друзья друзей, 3 - только пользователь.
	 * @return VKDoc_ReturnValue_notes_edit
	 */
	public function notes_edit($nid, $text, $title, $commentprivacy = null, $privacy = null){
		...
		if($commentprivacy !== null){ $params['commentprivacy'] = $commentprivacy;}
		if($privacy !== null){ $params['privacy'] = $privacy;}
		return new VKDoc_ReturnValue_notes_edit($this->Call('notes.edit',$params));

	}
	/**
	 * удаляет заметку пользователя
	 * @param $nid mixed id удаляемой заметки.
	 * @return VKDoc_ReturnValue_notes_delete
	 */
	public function notes_delete($nid){
		$params = array();
		$params['nid'] = $nid;
		return new VKDoc_ReturnValue_notes_delete($this->Call('notes.delete',$params));
	 ...
	 * @param $ownerid mixed идентификатор пользователя (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_notes_getComments
	 */
	public function notes_getComments($nid, $offset = null, $count = null, $sort = null, $ownerid = null){
		...
		if($sort !== null){ $params['sort'] = $sort;}
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_notes_getComments($this->Call('notes.getComments',$params));
	 ...
	 * @return VKDoc_ReturnValue_notes_createComment
	 */
	public function notes_createComment($nid, $message, $ownerid = null, $replyto = null){
		...
		return new VKDoc_ReturnValue_notes_createComment($this->Call('notes.createComment',$params));
	 ...
	 * @param $ownerid mixed идентификатор пользователя, владельца заметки (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_notes_editComment
	 */
	public function notes_editComment($id, $message, $ownerid = null){
		...
		$params['message'] = $message;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_notes_editComment($this->Call('notes.editComment',$params));
	 ...
	 * @param $ownerid mixed идентификатор пользователя, владельца заметки (по-умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_notes_deleteComment
	 */
	public function notes_deleteComment($id, $ownerid = null){
		$params = array();
		$params['id'] = $id;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_notes_deleteComment($this->Call('notes.deleteComment',$params));
	 ...
	 * @param $ownerid mixed идентификатор пользователя, владельца заметки (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_notes_restoreComment
	 */
	public function notes_restoreComment($id, $ownerid = null){
		$params = array();
		$params['id'] = $id;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_notes_restoreComment($this->Call('notes.restoreComment',$params));
	 ...
	 * @return VKDoc_ReturnValue_pages_get
	 */
	public function pages_get($global = null, $needhtml = null, $mid = null, $gid = null, $title = null, $pid = null){
		...
		return new VKDoc_ReturnValue_pages_get($this->Call('pages.get',$params));
	 ...
	 * @return VKDoc_ReturnValue_pages_save
	 */
	public function pages_save($Text, $gid, $pid){
		...
		$params['gid'] = $gid;
		$params['pid'] = $pid;
		return new VKDoc_ReturnValue_pages_save($this->Call('pages.save',$params));
	 ...
	 * @return VKDoc_ReturnValue_pages_saveAccess
	 */
	public function pages_saveAccess($edit, $view, $gid, $pid){
		...
		$params['gid'] = $gid;
		$params['pid'] = $pid;
		return new VKDoc_ReturnValue_pages_saveAccess($this->Call('pages.saveAccess',$params));
	 ...
	 * @return VKDoc_ReturnValue_pages_getVersion
	 */
	public function pages_getVersion($hid, $gid, $needhtml = null){
		...
		$params['gid'] = $gid;
		if($needhtml !== null){ $params['needhtml'] = $needhtml;}
		return new VKDoc_ReturnValue_pages_getVersion($this->Call('pages.getVersion',$params));
	 ...
	 * @param $gid mixed id группы, где создана страница.
	 * @param $pid mixed id вики-страницы.
	 * @return VKDoc_ReturnValue_pages_getHistory
	 */
	public function pages_getHistory($gid, $pid){
		$params = array();
		$params['gid'] = $gid;
		$params['pid'] = $pid;
		return new VKDoc_ReturnValue_pages_getHistory($this->Call('pages.getHistory',$params));
	 ...
	 * @return VKDoc_ReturnValue_pages_getTitles
	 */
	public function pages_getTitles($gid){
		$params = array();
		$params['gid'] = $gid;
		return new VKDoc_ReturnValue_pages_getTitles($this->Call('pages.getTitles',$params));

	}
	/**
	 * возвращает html-представление wiki-разметки.
	 * @return VKDoc_ReturnValue_pages_parseWiki
	 */
	public function pages_parseWiki(){
		$params = array();
		return new VKDoc_ReturnValue_pages_parseWiki($this->Call('pages.parseWiki',$params));
	 ...
	 * @return VKDoc_ReturnValue_stats_get
	 */
	public function stats_get($dateto, $datefrom, $aid, $gid){
		...
		$params['aid'] = $aid;
		$params['gid'] = $gid;
		return new VKDoc_ReturnValue_stats_get($this->Call('stats.get',$params));
	 ...
	 * @return VKDoc_ReturnValue_getUserInfo
	 */
	public function getUserInfo($apiid, $v, $sig, $testmode = null, $format = null){
		...
		return new VKDoc_ReturnValue_getUserInfo($this->Call('getUserInfo',$params));
	 ...
	 * @param $testmode mixed если этот параметр равен '1', разрешает тестовые запросы к данным приложения. При этом аутентификация не проводится и считается, что текущий пользователь – это автор приложения. Это позволяет тестировать приложение без загрузки его на сайт. По умолчанию '0'.
	 * @param $format mixed формат возвращаемых данных – 'XML' или 'JSON'. По умолчанию 'XML'.
	 * @return VKDoc_ReturnValue_getUserInfoEx
	 */
	public function getUserInfoEx($apiid, $v, $sig, $testmode = null, $format = null){
		...
		if($testmode !== null){ $params['testmode'] = $testmode;}
		if($format !== null){ $params['format'] = $format;}
		return new VKDoc_ReturnValue_getUserInfoEx($this->Call('getUserInfoEx',$params));
	 ...
	 * @param $random mixed любое случайное число для обеспечения уникальности запроса
	 * @param $timestamp mixed UNIX-time сервера.
	 * @return VKDoc_ReturnValue_secure_saveAppStatus
	 */
	public function secure_saveAppStatus($status, $uid, $random, $timestamp){
		...
		$params['random'] = $random;
		$params['timestamp'] = $timestamp;
		return new VKDoc_ReturnValue_secure_saveAppStatus($this->Call('secure.saveAppStatus',$params));
	 ...
	 * @param $random mixed любое случайное число для обеспечения уникальности запроса
	 * @param $timestamp mixed UNIX-time сервера.
	 * @return VKDoc_ReturnValue_secure_getAppStatus
	 */
	public function secure_getAppStatus($uid, $random, $timestamp){
		...
		$params['random'] = $random;
		$params['timestamp'] = $timestamp;
		return new VKDoc_ReturnValue_secure_getAppStatus($this->Call('secure.getAppStatus',$params));
	 ...
	 * @return VKDoc_ReturnValue_getVariable
	 */
	public function getVariable($key, $session = null, $userid = null){
		...
		return new VKDoc_ReturnValue_getVariable($this->Call('getVariable',$params));
	 ...
	 * @return VKDoc_ReturnValue_getVariables
	 */
	public function getVariables($key, $count, $session = null, $userid = null){
		...
		if($session !== null){ $params['session'] = $session;}
		if($userid !== null){ $params['userid'] = $userid;}
		return new VKDoc_ReturnValue_getVariables($this->Call('getVariables',$params));
	 ...
	 * @return VKDoc_ReturnValue_putVariable
	 */
	public function putVariable($key, $value, $session = null, $userid = null){
		...
		if($session !== null){ $params['session'] = $session;}
		if($userid !== null){ $params['userid'] = $userid;}
		return new VKDoc_ReturnValue_putVariable($this->Call('putVariable',$params));

	}
	/**
	 * возвращает таблицу рекордов.
	 * @return VKDoc_ReturnValue_getHighScores
	 */
	public function getHighScores(){
		$params = array();
		return new VKDoc_ReturnValue_getHighScores($this->Call('getHighScores',$params));

	}
	/**
	 * записывает результат текущего пользователя в таблицу рекордов.
	 * @param $score mixed рекорд пользователя для записи.
	 * @return VKDoc_ReturnValue_setUserScore
	 */
	public function setUserScore($score){
		$params = array();
		$params['score'] = $score;
		return new VKDoc_ReturnValue_setUserScore($this->Call('setUserScore',$params));
	 ...
	 * @return VKDoc_ReturnValue_sendMessage
	 */
	public function sendMessage($message, $session = null){
		$params = array();
		$params['message'] = $message;
		if($session !== null){ $params['session'] = $session;}
		return new VKDoc_ReturnValue_sendMessage($this->Call('sendMessage',$params));
	 ...
	 * @return VKDoc_ReturnValue_subscriptions_get
	 */
	public function subscriptions_get($count = null, $offset = null, $uid = null){
		...
		if($offset !== null){ $params['offset'] = $offset;}
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_subscriptions_get($this->Call('subscriptions.get',$params));
	 ...
	 * @param $offset mixed смещение, относительно начала списка, для выборки определенного подмножества. Если параметр не задан, то считается, что он равен 0.
	 * @param $uid mixed идентификатор пользователя, список которого необходимо получить. Если параметр не задан, то считается, что он равен идентификатору текущего пользователя.
	 * @return VKDoc_ReturnValue_subscriptions_getFollowers
	 */
	public function subscriptions_getFollowers($count = null, $offset = null, $uid = null){
		...
		if($offset !== null){ $params['offset'] = $offset;}
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_subscriptions_getFollowers($this->Call('subscriptions.getFollowers',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_getDialogs
	 */
	public function messages_getDialogs($previewlength = null, $count = null, $offset = null, $chatid = null, $uid = null){
		...
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_messages_getDialogs($this->Call('messages.getDialogs',$params));
	 ...
	 * @param $count mixed количество сообщений, которое необходимо получить (но не более 100).
	 * @param $offset mixed смещение, необходимое для выборки определенного подмножества сообщений.
	 * @return VKDoc_ReturnValue_messages_getHistory
	 */
	public function messages_getHistory($uid, $chatid, $count = null, $offset = null){
		...
		if($count !== null){ $params['count'] = $count;}
		if($offset !== null){ $params['offset'] = $offset;}
		return new VKDoc_ReturnValue_messages_getHistory($this->Call('messages.getHistory',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_getById
	 */
	public function messages_getById($mid, $mids, $previewlength = null){
		...
		$params['mids'] = $mids;
		if($previewlength !== null){ $params['previewlength'] = $previewlength;}
		return new VKDoc_ReturnValue_messages_getById($this->Call('messages.getById',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_get
	 */
	public function messages_get($previewlength = null, $timeoffset = null, $filters = null, $count = null, $offset = null, $out = null){
		...
		return new VKDoc_ReturnValue_messages_get($this->Call('messages.get',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_searchDialogs
	 */
	public function messages_searchDialogs($q, $fields = null){
		$params = array();
		$params['q'] = $q;
		if($fields !== null){ $params['fields'] = $fields;}
		return new VKDoc_ReturnValue_messages_searchDialogs($this->Call('messages.searchDialogs',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_search
	 */
	public function messages_search($q, $count = null, $offset = null){
		...
		if($count !== null){ $params['count'] = $count;}
		if($offset !== null){ $params['offset'] = $offset;}
		return new VKDoc_ReturnValue_messages_search($this->Call('messages.search',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_send
	 */
	public function messages_send($uid, $chatid, $lat = null, $guid = null, $type = null, $long = null, $forwardmessages = null, $message = null, $attachment = null, $title = null){
		...
		if($title !== null){ $params['title'] = $title;}
		return new VKDoc_ReturnValue_messages_send($this->Call('messages.send',$params));

	}
	/**
	 * удаляет сообщение.
	 * @param $mids mixed Список идентификаторов сообщений, разделённых через запятую.
	 * @return VKDoc_ReturnValue_messages_delete
	 */
	public function messages_delete($mids = null){
		$params = array();
		if($mids !== null){ $params['mids'] = $mids;}
		return new VKDoc_ReturnValue_messages_delete($this->Call('messages.delete',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_deleteDialog
	 */
	public function messages_deleteDialog($uid, $chatid, $limit = null, $offset = null){
		...
		if($limit !== null){ $params['limit'] = $limit;}
		if($offset !== null){ $params['offset'] = $offset;}
		return new VKDoc_ReturnValue_messages_deleteDialog($this->Call('messages.deleteDialog',$params));

	}
	/**
	 * восстанавливает только что удаленное сообщение.
	 * @param $mid mixed идентификатор сообщения.
	 * @return VKDoc_ReturnValue_messages_restore
	 */
	public function messages_restore($mid = null){
		$params = array();
		if($mid !== null){ $params['mid'] = $mid;}
		return new VKDoc_ReturnValue_messages_restore($this->Call('messages.restore',$params));

	}
	/**
	 * помечает сообщения как непрочитанные.
	 * @param $mids mixed список идентификаторов сообщений, разделенных запятой.
	 * @return VKDoc_ReturnValue_messages_markAsNew
	 */
	public function messages_markAsNew($mids){
		$params = array();
		$params['mids'] = $mids;
		return new VKDoc_ReturnValue_messages_markAsNew($this->Call('messages.markAsNew',$params));

	}
	/**
	 * помечает сообщения как прочитанные.
	 * @param $mids mixed список идентификаторов сообщений, разделенных запятой.
	 * @return VKDoc_ReturnValue_messages_markAsRead
	 */
	public function messages_markAsRead($mids){
		$params = array();
		$params['mids'] = $mids;
		return new VKDoc_ReturnValue_messages_markAsRead($this->Call('messages.markAsRead',$params));
	 ...
	 * @param $chatid mixed ID беседы, к которой будет относиться сообщение
	 * @param $uid mixed ID пользователя (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_messages_setActivity
	 */
	public function messages_setActivity($type, $chatid, $uid){
		...
		$params['chatid'] = $chatid;
		$params['uid'] = $uid;
		return new VKDoc_ReturnValue_messages_setActivity($this->Call('messages.setActivity',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_getLastActivity
	 */
	public function messages_getLastActivity($uid){
		$params = array();
		$params['uid'] = $uid;
		return new VKDoc_ReturnValue_messages_getLastActivity($this->Call('messages.getLastActivity',$params));

	}
	/**
	 * получить информацию о беседе.
	 * @param $chatid mixed идентификатор чата
	 * @return VKDoc_ReturnValue_messages_getChat
	 */
	public function messages_getChat($chatid){
		$params = array();
		$params['chatid'] = $chatid;
		return new VKDoc_ReturnValue_messages_getChat($this->Call('messages.getChat',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_createChat
	 */
	public function messages_createChat($uids, $title = null){
		$params = array();
		$params['uids'] = $uids;
		if($title !== null){ $params['title'] = $title;}
		return new VKDoc_ReturnValue_messages_createChat($this->Call('messages.createChat',$params));
	 ...
	 * @param $chatid mixed идентификатор чата
	 * @return VKDoc_ReturnValue_messages_editChat
	 */
	public function messages_editChat($title, $chatid){
		$params = array();
		$params['title'] = $title;
		$params['chatid'] = $chatid;
		return new VKDoc_ReturnValue_messages_editChat($this->Call('messages.editChat',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_getChatUsers
	 */
	public function messages_getChatUsers($chatid, $fields = null){
		$params = array();
		$params['chatid'] = $chatid;
		if($fields !== null){ $params['fields'] = $fields;}
		return new VKDoc_ReturnValue_messages_getChatUsers($this->Call('messages.getChatUsers',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_addChatUser
	 */
	public function messages_addChatUser($uid, $chatid){
		$params = array();
		$params['uid'] = $uid;
		$params['chatid'] = $chatid;
		return new VKDoc_ReturnValue_messages_addChatUser($this->Call('messages.addChatUser',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_removeChatUser
	 */
	public function messages_removeChatUser($uid, $chatid){
		$params = array();
		$params['uid'] = $uid;
		$params['chatid'] = $chatid;
		return new VKDoc_ReturnValue_messages_removeChatUser($this->Call('messages.removeChatUser',$params));

	}
	/**
	 * возвращает данные, необходимые для [[Подключение к LongPoll серверу|подключения к LongPoll серверу]]
	 * @return VKDoc_ReturnValue_messages_getLongPollServer
	 */
	public function messages_getLongPollServer(){
		$params = array();
		return new VKDoc_ReturnValue_messages_getLongPollServer($this->Call('messages.getLongPollServer',$params));
	 ...
	 * @return VKDoc_ReturnValue_messages_getLongPollHistory
	 */
	public function messages_getLongPollHistory($ts, $maxmsgid = null){
		$params = array();
		$params['ts'] = $ts;
		if($maxmsgid !== null){ $params['maxmsgid'] = $maxmsgid;}
		return new VKDoc_ReturnValue_messages_getLongPollHistory($this->Call('messages.getLongPollHistory',$params));
	 ...
	 * @return VKDoc_ReturnValue_wall_edit
	 */
	public function wall_edit($postid, $long = null, $placeid = null, $lat = null, $attachments = null, $message = null, $ownerid = null){
		...
		if($message !== null){ $params['message'] = $message;}
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_wall_edit($this->Call('wall.edit',$params));
	 ...
	 * @return VKDoc_ReturnValue_wall_delete
	 */
	public function wall_delete($postid, $ownerid = null){
		$params = array();
		$params['postid'] = $postid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_wall_delete($this->Call('wall.delete',$params));
	 ...
	 * @return VKDoc_ReturnValue_wall_restore
	 */
	public function wall_restore($postid, $ownerid = null){
		$params = array();
		$params['postid'] = $postid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_wall_restore($this->Call('wall.restore',$params));
	 ...
	 * @return VKDoc_ReturnValue_wall_addComment
	 */
	public function wall_addComment($text, $postid, $replytocid = null, $ownerid = null){
		...
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_wall_addComment($this->Call('wall.addComment',$params));
	 ...
	 * @return VKDoc_ReturnValue_wall_deleteComment
	 */
	public function wall_deleteComment($cid, $ownerid = null){
		$params = array();
		$params['cid'] = $cid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_wall_deleteComment($this->Call('wall.deleteComment',$params));
	 ...
	 * @param $cid mixed идентификатор комментария на стене пользователя.
	 * @param $ownerid mixed идентификатор пользователя, на чьей стене находится комментарий к записи. Если параметр не задан, то он считается равным идентификатору текущего пользователя.
	 * @return VKDoc_ReturnValue_wall_restoreComment
	 */
	public function wall_restoreComment($cid, $ownerid = null){
		$params = array();
		$params['cid'] = $cid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_wall_restoreComment($this->Call('wall.restoreComment',$params));
	 ...
	 * @return VKDoc_ReturnValue_wall_addLike
	 */
	public function wall_addLike($postid, $message = null, $repost = null, $ownerid = null){
		...
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_wall_addLike($this->Call('wall.addLike',$params));
	 ...
	 * @return VKDoc_ReturnValue_wall_deleteLike
	 */
	public function wall_deleteLike($postid, $ownerid = null){
		$params = array();
		$params['postid'] = $postid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_wall_deleteLike($this->Call('wall.deleteLike',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_getComments
	 */
	public function photos_getComments($pid, $sort = null, $count = null, $offset = null, $ownerid = null){
		...
		if($offset !== null){ $params['offset'] = $offset;}
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_photos_getComments($this->Call('photos.getComments',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_getAllComments
	 */
	public function photos_getAllComments($count = null, $offset = null, $aid = null, $ownerid = null){
		...
		if($aid !== null){ $params['aid'] = $aid;}
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_photos_getAllComments($this->Call('photos.getAllComments',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_createComment
	 */
	public function photos_createComment($message, $pid, $replytocid = null, $ownerid = null){
		...
		if($replytocid !== null){ $params['replytocid'] = $replytocid;}
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_photos_createComment($this->Call('photos.createComment',$params));
	 ...
	 * @param $message mixed текст комментария (минимальная длина - 2 символа).
	 * @param $ownerid mixed идентификатор пользователя (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_photos_editComment
	 */
	public function photos_editComment($id, $pid, $message, $ownerid = null){
		...
		$params['message'] = $message;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_photos_editComment($this->Call('photos.editComment',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_deleteComment
	 */
	public function photos_deleteComment($pid, $cid, $ownerid = null){
		...
		$params['cid'] = $cid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_photos_deleteComment($this->Call('photos.deleteComment',$params));
	 ...
	 * @param $cid mixed идентификатор комментария.
	 * @param $ownerid mixed идентификатор пользователя (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_photos_restoreComment
	 */
	public function photos_restoreComment($pid, $cid, $ownerid = null){
		...
		$params['cid'] = $cid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_photos_restoreComment($this->Call('photos.restoreComment',$params));
	 ...
	 * @param $offset mixed смещение, необходимое для выборки определенного подмножества фотографий.
	 * @param $uid mixed идентификатор пользователя (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_photos_getUserPhotos
	 */
	public function photos_getUserPhotos($extended = null, $sort = null, $count = null, $offset = null, $uid = null){
		...
		if($offset !== null){ $params['offset'] = $offset;}
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_photos_getUserPhotos($this->Call('photos.getUserPhotos',$params));
	 ...
	 * @param $pid mixed идентификатор фотографии.
	 * @param $ownerid mixed идентификатор пользователя (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_photos_getTags
	 */
	public function photos_getTags($pid, $ownerid = null){
		$params = array();
		$params['pid'] = $pid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_photos_getTags($this->Call('photos.getTags',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_putTag
	 */
	public function photos_putTag($x2, $y2, $y, $x, $pid, $uid, $ownerid = null){
		...
		$params['uid'] = $uid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_photos_putTag($this->Call('photos.putTag',$params));
	 ...
	 * @param $pid mixed идентификатор фотографии.
	 * @param $ownerid mixed идентификатор владельца фотографии (по умолчанию - текущий пользователь).
	 * @return VKDoc_ReturnValue_photos_removeTag
	 */
	public function photos_removeTag($tagid, $pid, $ownerid = null){
		...
		$params['pid'] = $pid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_photos_removeTag($this->Call('photos.removeTag',$params));

	}
	/**
	 * удаляет фотоальбом пользователя.
	 * @param $aid mixed идентификатор удаляемого альбома.
	 * @return VKDoc_ReturnValue_photos_deleteAlbum
	 */
	public function photos_deleteAlbum($aid){
		$params = array();
		$params['aid'] = $aid;
		return new VKDoc_ReturnValue_photos_deleteAlbum($this->Call('photos.deleteAlbum',$params));

	}
	/**
	 * возвращает адрес сервера для загрузки фотографии в качестве прикрепления к личному сообщению.
	 * @return VKDoc_ReturnValue_photos_getMessagesUploadServer
	 */
	public function photos_getMessagesUploadServer(){
		$params = array();
		return new VKDoc_ReturnValue_photos_getMessagesUploadServer($this->Call('photos.getMessagesUploadServer',$params));
	 ...
	 * @param $photo mixed параметр, возвращаемый в результате загрузки фотографий на сервер.
	 * @param $server mixed параметр, возвращаемый в результате загрузки фотографий на сервер.
	 * @return VKDoc_ReturnValue_photos_saveMessagesPhoto
	 */
	public function photos_saveMessagesPhoto($hash, $photo, $server){
		...
		$params['photo'] = $photo;
		$params['server'] = $server;
		return new VKDoc_ReturnValue_photos_saveMessagesPhoto($this->Call('photos.saveMessagesPhoto',$params));
	 ...
	 * @return VKDoc_ReturnValue_photos_delete
	 */
	public function photos_delete($pid, $oid){
		$params = array();
		$params['pid'] = $pid;
		$params['oid'] = $oid;
		return new VKDoc_ReturnValue_photos_delete($this->Call('photos.delete',$params));

	}
	/**
	 * возвращает список скрытых пользователей и групп в новостях.
	 * @return VKDoc_ReturnValue_newsfeed_getBanned
	 */
	public function newsfeed_getBanned(){
		$params = array();
		return new VKDoc_ReturnValue_newsfeed_getBanned($this->Call('newsfeed.getBanned',$params));
	 ...
	 * @return VKDoc_ReturnValue_newsfeed_addBan
	 */
	public function newsfeed_addBan($gids = null, $uids = null){
		$params = array();
		if($gids !== null){ $params['gids'] = $gids;}
		if($uids !== null){ $params['uids'] = $uids;}
		return new VKDoc_ReturnValue_newsfeed_addBan($this->Call('newsfeed.addBan',$params));
	 ...
	 * @return VKDoc_ReturnValue_newsfeed_deleteBan
	 */
	public function newsfeed_deleteBan($gids = null, $uids = null){
		$params = array();
		if($gids !== null){ $params['gids'] = $gids;}
		if($uids !== null){ $params['uids'] = $uids;}
		return new VKDoc_ReturnValue_newsfeed_deleteBan($this->Call('newsfeed.deleteBan',$params));
	 ...
	 * @return VKDoc_ReturnValue_likes_add
	 */
	public function likes_add($itemid, $type, $ownerid = null){
		...
		$params['type'] = $type;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_likes_add($this->Call('likes.add',$params));
	 ...
	 * @param $type mixed идентификатор типа Like-объекта. Подробнее об идентификаторах объектов можно узнать на странице [[Список типов Like-объектов]].
	 * @param $ownerid mixed идентификатор владельца Like-объекта. Если параметр не задан, то считается, что он равен идентифкатору текущего пользователя.
	 * @return VKDoc_ReturnValue_likes_delete
	 */
	public function likes_delete($itemid, $type, $ownerid = null){
		...
		$params['type'] = $type;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_likes_delete($this->Call('likes.delete',$params));
	 ...
	 * @return VKDoc_ReturnValue_likes_isLiked
	 */
	public function likes_isLiked($itemid, $type, $ownerid = null, $userid = null){
		...
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		if($userid !== null){ $params['userid'] = $userid;}
		return new VKDoc_ReturnValue_likes_isLiked($this->Call('likes.isLiked',$params));
	 ...
	 * @return VKDoc_ReturnValue_status_get
	 */
	public function status_get($uid = null){
		$params = array();
		if($uid !== null){ $params['uid'] = $uid;}
		return new VKDoc_ReturnValue_status_get($this->Call('status.get',$params));
	 ...
	 * @return VKDoc_ReturnValue_status_set
	 */
	public function status_set($audio = null, $text = null){
		$params = array();
		if($audio !== null){ $params['audio'] = $audio;}
		if($text !== null){ $params['text'] = $text;}
		return new VKDoc_ReturnValue_status_set($this->Call('status.set',$params));

	}
	/**
	 * возвращает информацию о списках друзей.
	 * @return VKDoc_ReturnValue_friends_getLists
	 */
	public function friends_getLists(){
		$params = array();
		return new VKDoc_ReturnValue_friends_getLists($this->Call('friends.getLists',$params));
	 ...
	 * @return VKDoc_ReturnValue_friends_addList
	 */
	public function friends_addList($name, $uids = null){
		$params = array();
		$params['name'] = $name;
		if($uids !== null){ $params['uids'] = $uids;}
		return new VKDoc_ReturnValue_friends_addList($this->Call('friends.addList',$params));
	 ...
	 * @return VKDoc_ReturnValue_friends_editList
	 */
	public function friends_editList($lid, $name, $uids = null){
		...
		$params['name'] = $name;
		if($uids !== null){ $params['uids'] = $uids;}
		return new VKDoc_ReturnValue_friends_editList($this->Call('friends.editList',$params));
	 ...
	 * @return VKDoc_ReturnValue_friends_add
	 */
	public function friends_add($uid, $text = null){
		$params = array();
		$params['uid'] = $uid;
		if($text !== null){ $params['text'] = $text;}
		return new VKDoc_ReturnValue_friends_add($this->Call('friends.add',$params));
	 ...
	 * @return VKDoc_ReturnValue_friends_delete
	 */
	public function friends_delete($uid){
		$params = array();
		$params['uid'] = $uid;
		return new VKDoc_ReturnValue_friends_delete($this->Call('friends.delete',$params));
	 ...
	 * @return VKDoc_ReturnValue_friends_getRequests
	 */
	public function friends_getRequests($out = null, $needmutual = null, $needmessages = null, $count = null, $offset = null){
		...
		if($count !== null){ $params['count'] = $count;}
		if($offset !== null){ $params['offset'] = $offset;}
		return new VKDoc_ReturnValue_friends_getRequests($this->Call('friends.getRequests',$params));

	}
	/**
	 * отклоняет все заявки на добавление в друзья.
	 * @return VKDoc_ReturnValue_friends_deleteAllRequests
	 */
	public function friends_deleteAllRequests(){
		$params = array();
		return new VKDoc_ReturnValue_friends_deleteAllRequests($this->Call('friends.deleteAllRequests',$params));
	 ...
	 * @return VKDoc_ReturnValue_friends_getSuggestions
	 */
	public function friends_getSuggestions($filter = null){
		$params = array();
		if($filter !== null){ $params['filter'] = $filter;}
		return new VKDoc_ReturnValue_friends_getSuggestions($this->Call('friends.getSuggestions',$params));
	 ...
	 * @return VKDoc_ReturnValue_polls_getById
	 */
	public function polls_getById($pollid, $ownerid = null){
		$params = array();
		$params['pollid'] = $pollid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_polls_getById($this->Call('polls.getById',$params));
	 ...
	 * @return VKDoc_ReturnValue_polls_addVote
	 */
	public function polls_addVote($answerid, $pollid, $ownerid = null){
		...
		$params['pollid'] = $pollid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_polls_addVote($this->Call('polls.addVote',$params));
	 ...
	 * @param $ownerid mixed идентификатор владельца опроса. Если параметр не указан, то он считается равным идентификатору текущего пользователя.
	 * @return VKDoc_ReturnValue_polls_deleteVote
	 */
	public function polls_deleteVote($answerid, $pollid, $ownerid = null){
		...
		$params['pollid'] = $pollid;
		if($ownerid !== null){ $params['ownerid'] = $ownerid;}
		return new VKDoc_ReturnValue_polls_deleteVote($this->Call('polls.deleteVote',$params));
	 ...
	 * @return VKDoc_ReturnValue_subscriptions_follow
	 */
	public function subscriptions_follow($uid){
		$params = array();
		$params['uid'] = $uid;
		return new VKDoc_ReturnValue_subscriptions_follow($this->Call('subscriptions.follow',$params));
	 ...
	 * @return VKDoc_ReturnValue_subscriptions_unfollow
	 */
	public function subscriptions_unfollow($uid){
		$params = array();
		$params['uid'] = $uid;
		return new VKDoc_ReturnValue_subscriptions_unfollow($this->Call('subscriptions.unfollow',$params));
	 ...
	 * @return VKDoc_ReturnValue_account_importContacts
	 */
	public function account_importContacts($contacts = null){
		$params = array();
		if($contacts !== null){ $params['contacts'] = $contacts;}
		return new VKDoc_ReturnValue_account_importContacts($this->Call('account.importContacts',$params));
	 ...
	 * @return VKDoc_ReturnValue_account_registerDevice
	 */
	public function account_registerDevice($token, $notext = null, $devicemodel = null, $systemversion = null){
		...
		return new VKDoc_ReturnValue_account_registerDevice($this->Call('account.registerDevice',$params));

	}
	/**
	 * отписывает устройство от Push уведомлений.
	 * @param $token mixed Идентификатор устройства, использованный в методе [[account.registerDevice]].
	 * @return VKDoc_ReturnValue_account_unregisterDevice
	 */
	public function account_unregisterDevice($token){
		$params = array();
		$params['token'] = $token;
		return new VKDoc_ReturnValue_account_unregisterDevice($this->Call('account.unregisterDevice',$params));
	 ...
	 * @param $token mixed Идентификатор устройства, использованный в методе [[account.registerDevice]].
	 * @return VKDoc_ReturnValue_account_setSilenceMode
	 */
	public function account_setSilenceMode($time, $token){
		$params = array();
		$params['time'] = $time;
		$params['token'] = $token;
		return new VKDoc_ReturnValue_account_setSilenceMode($this->Call('account.setSilenceMode',$params));

	}
	/**
	 * помечает текущего пользователя как online.
	 * @return VKDoc_ReturnValue_account_setOnline
	 */
	public function account_setOnline(){
		$params = array();
		return new VKDoc_ReturnValue_account_setOnline($this->Call('account.setOnline',$params));
	 ...
	 * @return VKDoc_ReturnValue_board_getTopics
	 */
	public function board_getTopics($gid, $preview = null, $previewlength = null, $count = null, $order = null, $tids = null, $extended = null, $offset = null){
		...
		if($extended !== null){ $params['extended'] = $extended;}
		if($offset !== null){ $params['offset'] = $offset;}
		return new VKDoc_ReturnValue_board_getTopics($this->Call('board.getTopics',$params));
	 ...
	 * @return VKDoc_ReturnValue_board_deleteTopic
	 */
	public function board_deleteTopic($tid, $gid){
		$params = array();
		$params['tid'] = $tid;
		$params['gid'] = $gid;
		return new VKDoc_ReturnValue_board_deleteTopic($this->Call('board.deleteTopic',$params));
	 ...
	 * @param $offset mixed Смещение, необходимое для выборки определенного подмножества сообщений.
	 * @return VKDoc_ReturnValue_board_getComments
	 */
	public function board_getComments($gid, $tid, $count = null, $extended = null, $offset = null){
		...
		if($extended !== null){ $params['extended'] = $extended;}
		if($offset !== null){ $params['offset'] = $offset;}
		return new VKDoc_ReturnValue_board_getComments($this->Call('board.getComments',$params));
	 ...
	 * @return VKDoc_ReturnValue_board_addComment
	 */
	public function board_addComment($gid, $tid, $attachments = null, $text = null){
		...
		if($attachments !== null){ $params['attachments'] = $attachments;}
		if($text !== null){ $params['text'] = $text;}
		return new VKDoc_ReturnValue_board_addComment($this->Call('board.addComment',$params));
	 ...
	 * @return VKDoc_ReturnValue_board_editComment
	 */
	public function board_editComment($gid, $cid, $tid, $attachments = null, $text = null){
		...
		if($attachments !== null){ $params['attachments'] = $attachments;}
		if($text !== null){ $params['text'] = $text;}
		return new VKDoc_ReturnValue_board_editComment($this->Call('board.editComment',$params));
	 ...
	 * @return VKDoc_ReturnValue_board_deleteComment
	 */
	public function board_deleteComment($cid, $tid, $gid){
		...
		$params['tid'] = $tid;
		$params['gid'] = $gid;
		return new VKDoc_ReturnValue_board_deleteComment($this->Call('board.deleteComment',$params));
	 ...
	 * @return VKDoc_ReturnValue_board_restoreComment
	 */
	public function board_restoreComment($cid, $tid, $gid){
		...
		$params['tid'] = $tid;
		$params['gid'] = $gid;
		return new VKDoc_ReturnValue_board_restoreComment($this->Call('board.restoreComment',$params));
	 ...
	 * @return VKDoc_ReturnValue_board_addTopic
	 */
	public function board_addTopic($text, $title, $gid){
		...
		$params['title'] = $title;
		$params['gid'] = $gid;
		return new VKDoc_ReturnValue_board_addTopic($this->Call('board.addTopic',$params));
	 ...
	 * @return VKDoc_ReturnValue_board_closeTopic
	 */
	public function board_closeTopic($tid, $gid){
		$params = array();
		$params['tid'] = $tid;
		$params['gid'] = $gid;
		return new VKDoc_ReturnValue_board_closeTopic($this->Call('board.closeTopic',$params));
	 ...
	 * @return VKDoc_ReturnValue_board_fixTopic
	 */
	public function board_fixTopic($tid, $gid){
		$params = array();
		$params['tid'] = $tid;
		$params['gid'] = $gid;
		return new VKDoc_ReturnValue_board_fixTopic($this->Call('board.fixTopic',$params));
	 ...
	 * @return VKDoc_ReturnValue_board_unfixTopic
	 */
	public function board_unfixTopic($tid, $gid){
		$params = array();
		$params['tid'] = $tid;
		$params['gid'] = $gid;
		return new VKDoc_ReturnValue_board_unfixTopic($this->Call('board.unfixTopic',$params));
	 ...
	 * @return VKDoc_ReturnValue_fave_getUsers
	 */
	public function fave_getUsers($fields = null){
		$params = array();
		if($fields !== null){ $params['fields'] = $fields;}
		return new VKDoc_ReturnValue_fave_getUsers($this->Call('fave.getUsers',$params));
	 ...
	 * @param $offset mixed смещение, необходимое для выборки определенного подмножества фотографий.
	 * @return VKDoc_ReturnValue_fave_getPhotos
	 */
	public function fave_getPhotos($count = null, $offset = null){
		$params = array();
		if($count !== null){ $params['count'] = $count;}
		if($offset !== null){ $params['offset'] = $offset;}
		return new VKDoc_ReturnValue_fave_getPhotos($this->Call('fave.getPhotos',$params));
	 ...
	 * @return VKDoc_ReturnValue_fave_getVideos
	 */
	public function fave_getVideos($offset = null, $count = null){
		$params = array();
		if($offset !== null){ $params['offset'] = $offset;}
		if($count !== null){ $params['count'] = $count;}
		return new VKDoc_ReturnValue_fave_getVideos($this->Call('fave.getVideos',$params));
	 ...
	 * @param $count mixed количество сообщений, которое необходимо получить (но не более 100).
	 * @param $offset mixed смещение, необходимое для выборки определенного подмножества сообщений.
	 * @return VKDoc_ReturnValue_fave_getPosts
	 */
	public function fave_getPosts($extended = null, $count = null, $offset = null){
		...
		if($count !== null){ $params['count'] = $count;}
		if($offset !== null){ $params['offset'] = $offset;}
		return new VKDoc_ReturnValue_fave_getPosts($this->Call('fave.getPosts',$params));

	}
	/**
	 * возвращает ссылки, которые текущий пользователь добавил в закладки.
	 * @return VKDoc_ReturnValue_fave_getLinks
	 */
	public function fave_getLinks(){
		$params = array();
		return new VKDoc_ReturnValue_fave_getLinks($this->Call('fave.getLinks',$params));
	 ...
	 * @return VKDoc_ReturnValue_auth_signup
	 */
	public function auth_signup($phone, $clientid, $clientsecret, $lastname, $firstname, $sid = null, $testmode = null, $password = null, $sex = null, $voice = null){
		...
		return new VKDoc_ReturnValue_auth_signup($this->Call('auth.signup',$params));
	 ...
	 * @return VKDoc_ReturnValue_auth_confirm
	 */
	public function auth_confirm($clientsecret, $clientid, $phone, $code, $testmode = null, $password = null){
		...
		if($testmode !== null){ $params['testmode'] = $testmode;}
		if($password !== null){ $params['password'] = $password;}
		return new VKDoc_ReturnValue_auth_confirm($this->Call('auth.confirm',$params));
	 ...
	 * @param $clientsecret mixed Секретный ключ Вашего приложения.
	 * @param $clientid mixed Идентификатор Вашего приложения.
	 * @return VKDoc_ReturnValue_auth_checkPhone
	 */
	public function auth_checkPhone($phone, $clientsecret = null, $clientid = null){
		...
		return new VKDoc_ReturnValue_auth_checkPhone($this->Call('auth.checkPhone',$params));
